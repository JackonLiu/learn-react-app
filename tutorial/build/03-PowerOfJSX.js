export default ` In the previous page we looked at JSX syntax where we displayed a string \`Hello World\` inside the \`div\` element. What's the big deal! What else can it do for us?
